...
export const services: ServiceType[] = [
  {
    ...
    imageAlt: "주방 스테인리스 후드를 전문 장비로 세척하는 늘깔끔 작업자",
  },
  {
    id: "move-out",
    slug: "move-out",
    ...
    imageAlt: "거실 테이블을 꼼꼼하게 닦고 있는 늘깔끔 작업자",
  },
  {
    id: "residential",
    slug: "residential",
    ...
    imageAlt: "이사 상자가 놓인 빈 집 바닥을 물걸레질하는 늘깔끔 작업자",
  },
  {
    id: "partial",
    slug: "partial",
    ...
    imageAlt: "창틀과 창문 새시를 꼼꼼하게 닦는 늘깔끔 작업자",
  },
];
