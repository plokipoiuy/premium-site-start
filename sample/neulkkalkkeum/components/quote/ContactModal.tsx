...
const optionClass =
  "flex items-center gap-4 rounded-2xl border border-divider px-5 py-4 text-left transition-colors hover:border-neul-green hover:bg-neul-green/5 focus-visible:outline-neul-green";
  ...
  return (
    <Modal isOpen={isOpen} onClose={close} title="1분 만에 문의하기">
      ...
      <div className="mt-6 flex flex-col gap-3">
        ...
        >
          <span className={`${iconWrapClass} bg-neul-green/10 text-neul-green`}>
        ...
        <a
          ...
          className={optionClass}
        >
          <span className={`${iconWrapClass} bg-neul-pink/10 text-neul-pink`}>
