...
const variants = {
  primary: "bg-neul-pink text-white shadow-soft hover:bg-[#e05c7c] focus-visible:outline-neul-pink",
  secondary:
    "bg-white text-neul-green border border-neul-green/20 hover:border-neul-green hover:bg-neul-green/5 focus-visible:outline-neul-green",
  ghost:
