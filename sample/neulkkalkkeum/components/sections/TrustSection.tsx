...
import { trustPoints } from "@/sample/neulkkalkkeum/lib/data/trust";
...
export function TrustSection() {
  return (
    <section id="about" className="section-padding bg-neul-bg">
            ...
            return (
              <Reveal key={point.id} delay={i * 0.1}>
                <div className="flex h-full flex-col gap-4 rounded-card bg-white p-7 shadow-soft lg:p-8">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-neul-green/8 text-neul-green">
