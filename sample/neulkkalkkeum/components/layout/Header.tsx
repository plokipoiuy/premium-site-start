...
import { Logo } from "@/sample/neulkkalkkeum/components/ui/Logo";
import { Button } from "@/sample/neulkkalkkeum/components/ui/Button";
import { navLinks, quoteCta } from "@/sample/neulkkalkkeum/lib/data/nav";
        ...
        <div className="flex items-center gap-3 lg:hidden">
          ...
          <button
            ...
            className={`flex h-10 w-10 items-center justify-center rounded-full transition-colors ${
              solid ? "text-neul-green hover:bg-neul-green/5" : "text-white hover:bg-white/10"
            }`}
          >
            ...
            {navLinks.map((link) => (
              <li key={link.href}>
                <a
                  ...
                  className="block rounded-lg px-3 py-3 text-base font-medium text-text-charcoal hover:bg-neul-green/5"
                >
                  {link.label}
                </a>
              </li>
