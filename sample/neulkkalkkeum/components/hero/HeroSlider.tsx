...
import { heroSlides } from "@/sample/neulkkalkkeum/lib/data/hero";
...
export function HeroSlider() {
  ...
  return (
    <section
      ...
      className="relative h-[90svh] min-h-[560px] w-full overflow-hidden bg-neul-green"
    >
        ...
        <div className="container-content w-full">
          <div className="max-w-[650px]">
            <AnimatePresence mode="wait">
              ...
              >
                <span className="font-manrope text-xs font-semibold uppercase tracking-[0.25em] text-neul-sage">
                  {slide.eyebrow}
                </span>
