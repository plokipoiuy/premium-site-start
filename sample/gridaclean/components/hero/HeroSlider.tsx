...
import { heroSlides } from "@/sample/gridaclean/lib/data/hero";
import { Button } from "@/sample/gridaclean/components/ui/Button";
...
export function HeroSlider() {
  ...
  return (
    <section
      ...
      className="relative h-[90svh] min-h-[560px] w-full overflow-hidden bg-grida-blue"
    >
        ...
        <div className="container-content w-full">
          <div className="max-w-[650px]">
            <AnimatePresence mode="wait">
              ...
              >
                <span className="font-manrope text-xs font-semibold uppercase tracking-[0.25em] text-grida-sky">
                  {slide.eyebrow}
                </span>
