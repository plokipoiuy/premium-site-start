...
const optionClass =
  "flex items-center gap-4 rounded-2xl border border-divider px-5 py-4 text-left transition-colors hover:border-grida-blue hover:bg-grida-blue/5 focus-visible:outline-grida-blue";
  ...
  return (
    <Modal isOpen={isOpen} onClose={close} title="1분 만에 문의하기">
      ...
      <div className="mt-6 flex flex-col gap-3">
        ...
        >
          <span className={`${iconWrapClass} bg-grida-blue/10 text-grida-blue`}>
        ...
        <a
          ...
          className={optionClass}
        >
          <span className={`${iconWrapClass} bg-grida-accent/10 text-grida-accent`}>
