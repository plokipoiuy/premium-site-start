...
import { Logo } from "@/sample/gridaclean/components/ui/Logo";
import { Button } from "@/sample/gridaclean/components/ui/Button";
import { navLinks, quoteCta } from "@/sample/gridaclean/lib/data/nav";
        ...
        <div className="flex items-center gap-3 lg:hidden">
          ...
          <button
            ...
            className={`flex h-10 w-10 items-center justify-center rounded-full transition-colors ${
              solid ? "text-grida-blue hover:bg-grida-blue/5" : "text-white hover:bg-white/10"
            }`}
          >
            ...
            {navLinks.map((link) => (
              <li key={link.href}>
                <a
                  ...
                  className="block rounded-lg px-3 py-3 text-base font-medium text-text-charcoal hover:bg-grida-blue/5"
                >
                  {link.label}
                </a>
              </li>
