...
import { faqItems } from "@/sample/gridaclean/lib/data/faq";
              ...
              <Reveal key={item.id} delay={i * 0.05}>
                <div className="border-b border-divider">
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-4 py-5 text-left focus-visible:outline-grida-blue"
                  >
                    ...
                    <ChevronDown
                      ...
                      className={`shrink-0 text-text-muted transition-transform duration-300 ${
                        isOpen ? "rotate-180 text-grida-blue" : ""
                      }`}
                      aria-hidden="true"
                    />
                  </button>
