...
import { heroSlides } from "@/sample/cheongsodaejang/lib/data/hero";
...
export function HeroSlider() {
  ...
  return (
    <section
      ...
      className="relative h-[90svh] min-h-[560px] w-full overflow-hidden bg-cheongso-blue"
    >
      <AnimatePresence mode="sync">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(3,105,161,0.85) 0%, rgba(3,105,161,0.55) 42%, rgba(3,105,161,0.15) 75%, rgba(3,105,161,0) 100%)",
            }}
            aria-hidden="true"
          />
        </motion.div>
        ...
        <div className="container-content w-full">
          <div className="max-w-[650px]">
            <AnimatePresence mode="wait">
              ...
              >
                <span className="font-manrope text-xs font-semibold uppercase tracking-[0.25em] text-cheongso-sky">
                  {slide.eyebrow}
                </span>
