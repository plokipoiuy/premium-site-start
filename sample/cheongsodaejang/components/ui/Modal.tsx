      ...
      >
        <div className="mb-5 flex items-center justify-between">
          ...
          <button
            ...
            aria-label="닫기"
            onClick={onClose}
            className="flex h-9 w-9 items-center justify-center rounded-full text-text-muted transition-colors hover:bg-ivory hover:text-text-charcoal focus-visible:outline-cheongso-blue"
          >
            <X size={20} />
          </button>
        </div>
