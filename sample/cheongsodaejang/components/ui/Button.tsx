...
const variants = {
  primary: "bg-cheongso-accent text-white shadow-soft hover:bg-[#D74668] focus-visible:outline-cheongso-accent",
  secondary:
    "bg-white text-cheongso-blue border border-cheongso-blue/20 hover:border-cheongso-blue hover:bg-cheongso-blue/5 focus-visible:outline-cheongso-blue",
  ghost:
