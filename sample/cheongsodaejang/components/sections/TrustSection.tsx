...
import { trustPoints } from "@/sample/cheongsodaejang/lib/data/trust";
            ...
            return (
              <Reveal key={point.id} delay={i * 0.1}>
                <div className="flex h-full flex-col gap-4 rounded-card bg-white p-7 shadow-soft lg:p-8">
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-cheongso-blue/8 text-cheongso-blue">
